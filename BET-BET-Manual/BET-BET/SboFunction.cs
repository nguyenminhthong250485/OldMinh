    ...
    public class SboFunction : IFunction
    {
        ...
        public void playBetNonLive(ticket o, string money, string IsLive, string phieuchung, string group)
        {
            ...
            if (o != null)
            {
                ...
                string UrlBetSbo = "http://" + Util.GetSubstringByString(welcomeLink, "http://", "&").Replace("default", "ticket/confirm") + "&sameticket=0&betcount=" + betcount + "&stake=" + usdbet.ToString() + "&ostyle=1&stakeInAuto=10&betpage=18&acceptIfAny=1&autoProcess=0&autoRefresh=1&oid=" + keoid + "&timeDiff=2100";
                ...
                if (double.Parse(oddbet) != odd)
                {
                    message = "SBO: [" + username + "] Odd Change " + odd + "/" + oddbet;
                }
                ...
                if (ProcessBet.IndexOf("onOrderSubmitted") == -1)
                {
                    ...
                    this.phieuchung = "";
                    message = "SBO: [" + username + "] BET FAILED - INFO: " + o.ToString();
                }
                else
                {
                    ...
                    message = "SBO: [" + username + "] BET SUCCESS - INFO: " + o.ToString();
                    betcount++;
                }
            }
        }
        public void playBetLive(ticket o, string money, string IsLive, string phieuchung, string group)
        {
            ...
            if (o != null)
            {
                ...
                string UrlTicketSbo = "http://" + Util.GetSubstringByString(welcomeLink, "http://", "&").Replace("default", "ticket/ticket") + "&id=" + keoid + "&op=" + choose + "&odds=" + odd + "&hdpType=" + hdpType + "&isor=-1&isLive=" + IsLive + "&betpage=18&style=1";
                string UrlBetSbo = "http://" + Util.GetSubstringByString(welcomeLink, "http://", "&").Replace("default", "ticket/confirm") + "&sameticket=0&betcount=" + betcount + "&stake=" + usdbet.ToString() + "&ostyle=1&stakeInAuto=10&betpage=18&acceptIfAny=1&autoProcess=0&autoRefresh=1&oid=" + keoid + "&timeDiff=2100";
        ...
        public void playBetUnder(ticket o, string money, string IsLive, string phieuchung, string group)
        {
            ...
            if (o != null)
            {
                ...
                {
                    db.doInsertTicket("SBOBET", username, o.bettype, o.hdp.ToString(), o.home, o.away, choose, oddbet, money, usd, "DX", phieuchung);
                    this.phieuchung = phieuchung;
                    message = "SBO: [" + username + "] BET SUCCESS - INFO: " + o.ToString();
                    betcount++;
                }
