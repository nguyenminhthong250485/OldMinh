...
namespace ClickVN868
{
    public class SeleniumHelper
    {
        ...
        public ReadOnlyCollection<IWebElement> FindElements(By by, int timeout = 30)
        {
            ...
            if (timeout > 0)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    s.Stop();
                    timeout = (int)(timeout - s.Elapsed.TotalSeconds);
                    elements = FindElements(by, timeout);
                }
            }
            return elements;
        }
        ...
        public Bitmap CaptureScreenShot(IWebElement element)
        {
