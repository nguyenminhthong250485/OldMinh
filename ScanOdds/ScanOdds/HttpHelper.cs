...
namespace ScanOdds
{
    public class HttpHelper
    {
        ...
        public string Fetch(string url, HttpMethod method, string referer, string postData, string ip = "", string Ori = "")
        {
            string r = string.Empty;
            try
            {
                using (HttpWebResponse res = FetchResponse(url, method, referer, postData, ip, Ori))
                {
                    if (res != null)
                    {
        ...
        private HttpWebResponse FetchResponse(string url, HttpMethod method, string referer, string postData, string ip = "", string Ori = "")
        {
